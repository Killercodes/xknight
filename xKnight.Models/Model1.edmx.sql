...
-- --------------------------------------------------
-- Date Created: 09/22/2012 11:39:52
...
IF OBJECT_ID(N'[dbo].[FK_Attack_HostPage]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Attack] DROP CONSTRAINT [FK_Attack_HostPage];
GO
IF OBJECT_ID(N'[dbo].[FK_Form_HostPage]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Form] DROP CONSTRAINT [FK_Form_HostPage];
GO
IF OBJECT_ID(N'[dbo].[FK_Host_CrawlSetting]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Host] DROP CONSTRAINT [FK_Host_CrawlSetting];
GO
IF OBJECT_ID(N'[dbo].[FK_HostPage_Host]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[HostPage] DROP CONSTRAINT [FK_HostPage_Host];
GO
IF OBJECT_ID(N'[dbo].[FK_HostPage_HostPage]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[HostPage] DROP CONSTRAINT [FK_HostPage_HostPage];
GO
IF OBJECT_ID(N'[dbo].[FK_XAttack_Attack]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[XAttack] DROP CONSTRAINT [FK_XAttack_Attack];
GO
IF OBJECT_ID(N'[dbo].[FK_XAttack_Form]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[XAttack] DROP CONSTRAINT [FK_XAttack_Form];
GO
...
IF OBJECT_ID(N'[dbo].[Attack]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Attack];
GO
IF OBJECT_ID(N'[dbo].[CrawlSetting]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CrawlSetting];
GO
...
IF OBJECT_ID(N'[dbo].[Host]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Host];
GO
IF OBJECT_ID(N'[dbo].[HostPage]', 'U') IS NOT NULL
    DROP TABLE [dbo].[HostPage];
GO
IF OBJECT_ID(N'[dbo].[sysdiagrams]', 'U') IS NOT NULL
    DROP TABLE [dbo].[sysdiagrams];
GO
IF OBJECT_ID(N'[dbo].[XAttack]', 'U') IS NOT NULL
    DROP TABLE [dbo].[XAttack];
GO
