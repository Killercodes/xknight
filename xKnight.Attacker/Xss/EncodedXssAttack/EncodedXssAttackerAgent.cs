...
{
    internal class EncodedXssAttackerAgent : AttackerAgent
    {
        #region Fields
        ...
        private string DoAttack(Form form, string attackContent)
        {
            try
            {
                ...
                EncodedXssAttackAnnounceItem announceItem = new EncodedXssAttackAnnounceItem(_xAttack, EncodedXssAttackStatus.AttackStarted, _sharedResource, "", DateTime.Now);
                ...
                using (HttpWebResponse response = request.GetResponse() as HttpWebResponse)
                {
                        ...
                        )
                    {
                        using (StreamReader sr = new StreamReader(response.GetResponseStream()))
                        {
                            ...
                            announceItem = new EncodedXssAttackAnnounceItem(_xAttack, EncodedXssAttackStatus.AttackFinished, _sharedResource, "", DateTime.Now);
                            OnAgentAttackAnnounced(announceItem);
                    ...
                    {
                        announceItem = new EncodedXssAttackAnnounceItem(_xAttack, EncodedXssAttackStatus.AttackHalted, _sharedResource, "", DateTime.Now);
                        OnAgentAttackAnnounced(announceItem);
                        return null;
                    }
                }
            ...
            {
                EncodedXssAttackAnnounceItem announceItem = new EncodedXssAttackAnnounceItem(_xAttack, EncodedXssAttackStatus.AttackHalted, _sharedResource, "", DateTime.Now);
                OnAgentAttackAnnounced(announceItem);
                return null;
            }
        }
